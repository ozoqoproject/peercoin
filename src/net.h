...
/** pozoqo: Number of consecutive PoS headers are allowed from a single peer. Used to prevent out of memory attack. */
...
public:
    ...
    uint256 hashCheckpointKnown; // pozoqo: known sent sync-checkpoint
    ...
    // pozoqo: used to detect branch switches
