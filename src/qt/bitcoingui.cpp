    ...
    m_network_style(networkStyle)
{
    ...
    if(settings.value("bCheckGithub").toBool()) {
        ...
        QUrl url("https://api.github.com/repos/pozoqo/pozoqo/releases/latest");
...
void BitcoinGUI::onResult(QNetworkReply *reply) {
    if(reply->error() == QNetworkReply::NoError) {
        std::regex versionRgx("v([0-9]+).([0-9]+).([0-9]+)pzq");
        std::smatch matches;
        int newVersion=0;
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Pozoqo address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pozoqo: URIs)"));
...
//    connect(multisigAction, SIGNAL(triggered()), this, SLOT(gotoMultisigPage()));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Pozoqo addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify Message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Pozoqo addresses"));
    ...
    openAction->setStatusTip(tr("Open a pozoqo: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Pozoqo command-line options").arg(PACKAGE_NAME));

    openWebAction = new QAction(tr("&Website"), this);
    openWebAction->setStatusTip(tr("Open the Pozoqo website in a web browser."));

    openDonateAction = new QAction(tr("&Donate"), this);
    openDonateAction->setStatusTip(tr("Finacially support development of the Pozoqo project."));

    openChatroomAction = new QAction(tr("&Chatroom"), this);
    openChatroomAction->setStatusTip(tr("Open the Pozoqo Discord chat in a web browser."));

    openForumAction = new QAction(tr("&Forum"), this);
    openForumAction->setStatusTip(tr("Open talk.pozoqo.tech in a web browser."));
...
void BitcoinGUI::openWeb() {
    QDesktopServices::openUrl(QUrl("https://pozoqo.tech"));
}

void BitcoinGUI::openDonate() {
    QDesktopServices::openUrl(QUrl("https://www.pozoqo.tech/foundation"));
}
...
void BitcoinGUI::openForum() {
    QDesktopServices::openUrl(QUrl("https://talk.pozoqo.tech"));
}
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Pozoqo network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
