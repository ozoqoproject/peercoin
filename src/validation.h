...
static const bool DEFAULT_TXINDEX = true;  // pozoqo: txindex is required for PoS calculations (might change in the future)
...
bool GetCoinAge(const CTransaction& tx, const CCoinsViewCache &view, uint64_t& nCoinAge, unsigned int nTimeTx, bool isTrueCoinAge = true); // pozoqo: get transaction coin age
