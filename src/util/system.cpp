...
const char * const BITCOIN_CONF_FILENAME = "pozoqo.conf";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Pozoqo
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Pozoqo
    // Mac: ~/Library/Application Support/Pozoqo
    // Unix: ~/.pozoqo
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Pozoqo";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Pozoqo";
#else
    // Unix
    return pathRet / ".pozoqo";
#endif
#endif
}
