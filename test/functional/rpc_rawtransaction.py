...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "Invalid Pozoqo address", self.nodes[0].createrawtransaction, [], {'foo': 0})
        ...
        # witness transaction
        encrawtx = "01000000000000000001010000000000000072c1a6a246ae63f74f931e8365e15a089c68d61900000000000000000000ffffffff0100e1f50500000000000102616100000000"
